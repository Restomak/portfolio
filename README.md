    ...
    <section id="about">
        <div class="container mt-4 pt-4">
            ...
            <div class="row mt-4 other-text">
                <div class="col-lg-12 other-text">
